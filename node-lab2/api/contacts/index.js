...
router.post('/', (req, res) => {
  ...
  if (newContact) {
    ...
    res.status(400)
              .send({message: 'Unable to find Contact in request. No Contact found in body'});
  }
});
...
router.put('/:id', (req, res) => {
  ...
  if (index != -1) {
    ...
    res.status(400).send({message: 'Unable to find Contact in request. No Contract found in body'});
  }
});
